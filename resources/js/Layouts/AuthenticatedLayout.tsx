        ...
        <div className="min-h-screen bg-slate-50 dark:bg-slate-900 transition-colors duration-300">
            {permissionsGranted === false && !hidePermissionOverlay && (
                <div className="fixed inset-0 z-[9999] flex flex-col items-center justify-center p-4 bg-slate-950/80 dark:bg-slate-950/90 backdrop-blur-md text-white">
                    <div className="relative max-w-sm w-full max-h-[90vh] overflow-y-auto bg-white dark:bg-slate-800 rounded-2xl p-4 sm:p-5 shadow-2xl text-slate-800 dark:text-white border border-slate-100 dark:border-slate-700/50 text-center flex flex-col items-center space-y-3 animate-bounce-in custom-scrollbar">
                        {/* Tombol Tutup Silang di Pojok Kanan Atas */}
                        <button
                            type="button"
                            onClick={closePermissionOverlay}
                            className="absolute top-3 right-3 text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 transition-colors p-1 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-700/50"
                        ...
                        <div className="relative">
                            ...
                            <div className="relative w-10 h-10 bg-indigo-100 dark:bg-indigo-900/50 rounded-xl flex items-center justify-center text-indigo-600 dark:text-indigo-400">
                        ...
                        <div>
                            ...
                            <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-1 leading-relaxed">
                                Aplikasi HRIS Geolocation memerlukan akses <b>Lokasi (GPS)</b> dan <b>Notifikasi</b> untuk fitur presensi dan pemberitahuan sistem.
                            </p>
                        </div>

                        <div className="w-full space-y-2 bg-slate-50 dark:bg-slate-900/50 p-3 rounded-xl border border-slate-100 dark:border-slate-800 text-left">
                            {/* NOTIFICATION ITEM */}
                            <div className="space-y-1.5">
                                ...
                                {notifState !== 'granted' && notifState !== 'unsupported' && (
                                    <button
                                        ...
                                        className="w-full mt-1 py-1.5 px-3 bg-indigo-600 hover:bg-indigo-700 disabled:bg-indigo-400 text-white text-[11px] font-bold rounded-lg transition-all active:scale-[0.98] flex items-center justify-center gap-1 shadow-sm"
                                    >
                        ...
                        {(notifState === 'denied' || geoState === 'denied') && (
                            <div className="w-full text-left space-y-2 bg-rose-50 dark:bg-rose-950/20 border border-rose-100 dark:border-rose-900/50 p-2.5 rounded-xl">
                                <div className="flex items-center gap-1.5 text-rose-600 dark:text-rose-400 font-bold text-xs">
                                    ...
                                    <span>Panduan Membuka Blokir Izin:</span>
                                </div>

                                {getDeviceOS() === 'ios' && (
                                    <div className="text-[10px] text-slate-750 dark:text-slate-350 space-y-1 bg-white dark:bg-slate-900 p-2 rounded-lg border dark:border-slate-800 leading-relaxed">
                                        <ol className="list-decimal list-inside space-y-0.5">
                                            <li>Ketuk ikon <b>aA</b> / opsi di kiri kolom alamat URL Safari.</li>
                                            <li>Pilih **Pengaturan Situs Web** &rarr; ubah **Lokasi** &rarr; **Izinkan**.</li>
                                            <li>GPS aktif: **Pengaturan iOS** &rarr; **Privasi** &rarr; **Layanan Lokasi** &rarr; **Safari** &rarr; **Izinkan**.</li>
                                        </ol>
                                    </div>
                                )}
                                ...
                                {getDeviceOS() === 'android' && (
                                    <div className="text-[10px] text-slate-750 dark:text-slate-350 space-y-1 bg-white dark:bg-slate-900 p-2 rounded-lg border dark:border-slate-800 leading-relaxed">
                                        <ol className="list-decimal list-inside space-y-0.5">
                                            <li>Ketuk ikon **Gembok / Opsi** di kiri kolom alamat URL Chrome.</li>
                                            <li>Pilih **Setelan Situs** / **Izin** &rarr; ubah **Lokasi & Notifikasi** &rarr; **Izinkan**.</li>
                                        </ol>
                                    </div>
                                )}
                                ...
                                {getDeviceOS() === 'desktop' && (
                                    <div className="text-[10px] text-slate-750 dark:text-slate-350 space-y-1 bg-white dark:bg-slate-900 p-2 rounded-lg border dark:border-slate-800 leading-relaxed">
                                        <ol className="list-decimal list-inside space-y-0.5">
                                            <li>Klik ikon **Gembok** di sebelah kiri kolom alamat URL browser.</li>
                                            <li>Ubah izin **Lokasi & Notifikasi** menjadi **Izinkan**.</li>
                                        </ol>
                                    </div>
                                )}
                                ...
                                <button
                                    ...
                                    className="w-full mt-1.5 py-1.5 px-3 bg-indigo-600 hover:bg-indigo-700 text-white font-bold text-[11px] rounded-lg shadow transition-colors flex items-center justify-center gap-1"
                                >
                                    Muat Ulang Halaman
                                </button>
                            </div>
                        ...
                        <div className="w-full border-t border-slate-100 dark:border-slate-800/80 pt-2.5">
                            <button
                                type="button"
                                onClick={closePermissionOverlay}
                                className="w-full py-1.5 px-3 bg-slate-100 hover:bg-slate-200 dark:bg-slate-700/60 dark:hover:bg-slate-700 text-slate-600 dark:text-slate-300 font-bold text-[11px] rounded-lg transition-colors flex items-center justify-center gap-1.5"
                            >
